...
//        roomButtons[room_counter].setUnpressedFillColor(Color.yellow);
    ...
    private void callPython() {
        ...
        System.out.println("array passed to python code -> ");
        for (int i = 0; i < requiredRooms.length; i++) {
            System.out.print(requiredRooms[i]+" # ");
        }
        System.out.println("");
        try {
            ...
            if (result != null && result.length!=1) {
                ...
                System.out.println("size of array received from python -> "+result.length);
