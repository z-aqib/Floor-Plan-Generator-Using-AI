...
def dfs(node, parent_room, constraints, balcony_count, garage_count):
    ...
    for child in node.children:
        if not dfs(child, node.room, constraints, balcony_count, garage_count):
            return False
...
def check_constraints(root, constraints):
    ...
    if not dfs(root, None, constraints, balcony_count, garage_count):
        return False
...
def main(rd):
    ...
    if room_designs:
        ...
        return ["Constraints violated. Unable to generate valid room designs."]
