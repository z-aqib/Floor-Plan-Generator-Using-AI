...
// commented
public class KDrawPanel extends JPanel implements ActionListener, MouseInputListener {
    ...
    private final int[] panel; // size of the panel
    ...
    // window-appication features
    private KeypadWindow window; // a window is created which has the keypad
    private final UserInput input; // input of user

    public KDrawPanel(int[] panel, UserInput input) {
        /*
        this is the constructor of the KDrawPanel class. it intializes and sets the panel
        first, then intializes the objects to be painted on the panel.
         */
        // assign given values of constructor
        this.panel = panel;
        this.input = input;
        // assign features and default values of panel
    ...
    private void intializeObjects() {
        ...
        add(this.mouseState);
        this.window = new KeypadWindow(panel, input);
    }
